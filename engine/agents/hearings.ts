...
import { BELIEF, CONVERSE, HEARING, TENSION } from '../core/config.ts';
...
import { clampSigned, clampUnit, fpMul, SCALE, type Fixed } from '../core/fixedpoint.ts';
import type { InferenceClient } from '../inference/index.ts';
import { loadRouteGraph, type RouteGraph } from '../simulation/movement.ts';
