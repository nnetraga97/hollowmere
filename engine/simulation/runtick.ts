...
import { COGNITION, TIME } from '../core/config.ts';
import { runAccusations } from '../agents/accusations.ts';
import { applyCognition, selectSpotlight, think, type CognitionDecision } from '../agents/cognition.ts';
import { runGossip } from '../social/gossip.ts';
import { applyDialogue, thinkDialogue, type DialogueDecision } from '../agents/dialogue.ts';
import { evaluateExposureEnding } from './exposure.ts';
import { runHearings } from '../agents/hearings.ts';
...
import { tickRng } from '../core/rng.ts';
import { applyStrategy, thinkStrategy, type SchemeDecision } from '../agents/schemes.ts';
import {
...
import { clampUnit, type Fixed } from '../core/fixedpoint.ts';
import type { InferenceClient } from '../inference/index.ts';
import { hasConversationHold } from '../player/conversation.ts';
